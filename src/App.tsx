  ...
  return (
    <>
      ...
      <section className='primary-display flex tablet:h-[calc(100vh-7.6rem)] h-[calc(100vh-6.4rem)]'>
        ...
        <main className='board-display flex flex-grow justify-center items-center border-t-[1px] border-lavender dark:border-lines-dark bg-lgt-gray dark:bg-very-dark-gray overflow-x-hidden transition-colors duration-500'>
